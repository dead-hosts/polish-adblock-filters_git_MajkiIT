...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of polish-adblock-filters"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of polish-adblock-filters"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/polish-adblock-filters_git_MajkiIT/'
